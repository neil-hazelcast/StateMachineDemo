...
/**
 * A class for holding an Order.  The main thing here is the OrderStatus Enum
 * which is used for holding state for the Order.
 * @author nstickels
 *
 */
public class Order implements Serializable{
	...
	public Order(UUID orderId, OrderStatus status)
	{
		this.orderId = orderId;
		this.status = status;
	}
